...
export const DEFAULT_CATEGORIES: Category[] = [
  ...
  { id: 'transport', name: 'Transport', icon: 'car', color: '#7C6FFF', type: 'expense', isCustom: false },
  ...
  { id: 'travel', name: 'Travel', icon: 'airplane', color: '#A855F7', type: 'expense', isCustom: false },
  ...
  { id: 'subscriptions', name: 'Subscriptions', icon: 'tv', color: '#6366F1', type: 'expense', isCustom: false },
  ...
  { id: 'freelance', name: 'Freelance', icon: 'laptop', color: '#7C6FFF', type: 'income', isCustom: false },
...
export const WALLET_COLORS = [
  '#7C6FFF', '#FF6B8A', '#00D9A0', '#FFB830',
  '#4ECDC4', '#FF8C00', '#A855F7', '#F97316',
